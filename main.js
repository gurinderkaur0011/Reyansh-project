...
function identify(){
    model.classify(document.getElementById("result_image"),function(error,result){
        if(error){
            console.error(error);
        }
        else{
            ...
            var prediction=result[0].label + "<span class='emoji'>" + em[0] + "</span>" + ", " + result[1].label + "<span class='emoji'>" + em[1] + "</span>";
